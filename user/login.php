...
$_SESSION['phn']=$result->MobileNumber;
}
...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>       
        <title>College Amenity Booking System - Login Page</title>
            ...
            <main id="main-container">
                        ...
                        <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                            <div class="p-30 invisible" data-toggle="appear">
                                <p class="font-size-h3 font-w600 text-white">
                                    College Amenity Booking System
                                </p>
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w700" href="login.php">
                                        ...
                                        <span class="font-size-xl">Booking System</span>
                                    </a>
                ...
                <label for="keep_me_logged_in">Keep me signed in</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        </button> &nbsp;&nbsp; <a href="newuser.php"> New User !!! </a>
                                        <div class="mt-30">
