...
if (strlen($_SESSION['odmsaid']==0)) 
{
  ...
  $email=$_POST['email'];
  $sql="update tbladmin set UserName=:username,MobileNumber=:mobilenumber,Email=:email where ID=:aid";
...
<!doctype html>
 <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
 <title>College Amenity Booking System - User Profile</title>
...
$sql="SELECT UserName,AdminName,Email,MobileNumber,UserRegdate from  user where ID=:aid";
$query = $dbh -> prepare($sql);
$query->bindParam(':aid',$aid,PDO::PARAM_STR);
$query->execute();
...
{               ?>
                                    <form method="post">
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-username">User Name:</label>
                                            <div class="col-12">
                                                <input type="text" class="form-control" name="username" value="<?php  echo $row->UserName;?>" readonly="true">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-email">Admin Name:</label>
                                            <div class="col-12">
                                        ...
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                 <input type="text" class="form-control" id="email2" name="" value="<?php  echo $row->UserRegdate;?>" readonly="true">
                                            </div>
                                        </div>
                                      <?php $cnt=$cnt+1;}} ?>
                                        <div class="form-group row">
