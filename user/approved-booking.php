...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        <title>College Amenity Booking System - Approved Booking</title>
...
$sql="SELECT * from tblbooking where Status='Approved' and Name=:name ";
...
if($query->rowCount() > 0)
{
	...
	<thead>
                                    <tr>
                                        ...
                                        <th class="d-none d-sm-table-cell" style="width: 15%;">Invoice</th>
                                       </tr>
                                </thead>
                                <tbody>
