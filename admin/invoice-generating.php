...
<!doctype html>
 <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
 <title>College Amenity Booking System - View Invoice</title>
...
{               ?>
  ...
  <tr>
    <th style="text-align: center;" colspan="2">Additional Requirements</th>
   
  
  <?php  
  $bid= $row->BookingID;
 $sql2="SELECT * from bookreqtbl where  BookingID=:bid ";
...
{         
 ...
 <td style="text-align: center;" colspan="2"><?php  echo $row->Requirement;?></td>
<?php } }?>
