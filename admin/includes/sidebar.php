                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="dashboard.php">
                                        ...
                                        <span class="font-size-xl text-dual-primary-dark"> College </span><span class="font-size-xl text-primary">Amenity</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
...
{               ?>
                                    <li class="list-inline-item">
                                        <a class="link-effect text-dual-primary-dark font-size-xs font-w600 text-uppercase" href="admin-profile.php"><?php  echo $row->UserName;?></a>
                                    </li><?php $cnt=$cnt+1;}} ?>
                                    <li class="list-inline-item">
                                        <!-- Layout API, functionality initialized in Codebase() -> uiApiLayout() -->
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
								...
								<li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-energy"></i><span class="sidebar-mini-hide">Type of Requirements</span></a>
                                    <ul>
                                        <li>
                                            <a href="add-req.php">Add New Requirements</a>
                                        </li>
                                        <li>
                                            <a href="manage-req.php">Manage Requirements</a>
                                        </li>
