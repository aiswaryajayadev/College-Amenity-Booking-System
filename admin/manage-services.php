...
{               ?>
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell">
                                         ...
                                         <td class="d-none d-sm-table-cell"><a href="manage-services.php?delid=<?php echo ($row->ID);?>" onclick="return confirm('Do you really want to Delete ?');"><i class="fa fa-trash fa-delete" aria-hidden="true"> </i></a> || <a href="update_serv.php?invid=<?php echo htmlentities ($row->ID);?>">Update</i></a> </td>
                                    </tr>
                                    <?php $cnt=$cnt+1;}} ?> 
